        ...
        <div className="min-h-screen bg-white flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                <div className="border-4 border-black p-8">
                    ...
                    <p className="text-sm text-black mb-8 uppercase tracking-widest opacity-60">Create Seller Account</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            <label htmlFor="name" className="block text-sm font-bold mb-2 uppercase tracking-wide text-black">
                                Full Name
                            </label>
                            <input
                                id="name"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="••••••••"
                            />
                            <p className="text-xs text-black opacity-50 mt-1">Minimum 6 characters</p>
                        </div>
